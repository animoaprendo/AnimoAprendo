...
import { Search, Calendar, Clock, Users, Star, BookOpen, MapPin, AlertCircle, CheckCircle, Loader2 } from "lucide-react";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-3xl font-bold mb-2">{statistics.completed}</h3>
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-3xl font-bold mb-2">{statistics.averageRating || "N/A"}</h3>
                ...
                {filteredData.length === 0 ? (
                    ...
                    <TableCell colSpan={6} className="text-center py-12">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {search ? "Try adjusting your search terms" : "Your completed sessions will appear here"}
                        </p>
                      </div>
                    </TableCell>
                  </TableRow>
                  ...
                  filteredData.map((item) => (
                    <TableRow key={item.id} className="text-center">
                      <TableCell className="font-medium">{item.Tutee}</TableCell>
              ...
              {[1, 2, 3, 4, 5].map((n) => (
                <button
                  ...
                  className={`text-4xl transition-colors hover:scale-110 transform ${
                    tempRating >= n ? "text-yellow-500" : "text-gray-300 hover:text-yellow-400"
