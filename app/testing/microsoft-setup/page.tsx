...
export default function MicrosoftSetupPage() {
  ...
  const envCheck = {
    ...
    tenantId: !!process.env.GOOGLE_PROJECT_ID
  };
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Complete setup and verification guide for Google OAuth integration with Clerk
        </p>
      </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <div className="grid gap-3">
            ...
            <div className="flex items-center justify-between">
              <span className="font-medium">GOOGLE_PROJECT_ID</span>
...
GOOGLE_PROJECT_ID=your-project-id`}
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2">
            ...
            >
              ...
              <span className="font-medium text-blue-800">Google Cloud Credentials</span>
            </a>
      ...
      <Card className="mb-6 border-orange-200 bg-orange-50">
        <CardHeader>
          <CardTitle className="text-orange-800">Google Cloud Verification Checklist</CardTitle>
          <p className="text-sm text-orange-700">
            Use this checklist to verify your Google OAuth app is configured correctly
          </p>
        </CardHeader>
        <CardContent>
          <div className="space-y-2 text-sm">
          ...
          <div className="space-y-4 text-sm">
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <ul className="list-disc list-inside ml-4 text-red-600 space-y-1">
                ...
                <li>Google app scopes are not configured correctly</li>
                <li>User needs to disconnect and reconnect their Google account</li>
              </ul>
            </div>
            ...
            <div className="border-l-4 border-yellow-500 pl-4">
              ...
              <ul className="list-disc list-inside ml-4 text-yellow-600 space-y-1">
                <li>Ensure scopes include profile, email, and calendar.events</li>
                <li>Verify OAuth consent screen is configured for those scopes</li>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <ul className="list-disc list-inside ml-4 text-blue-600 space-y-1">
                <li>Check Google OAuth client has correct Clerk redirect URI</li>
